...
/**
 * Basically a giant rehash of the PTUI that places completely random tiles anywhere on the board based
 * on what the dimensions of the board are.
 *
 * @author Miguel Rosario
 */
public class ForbiddenUltimateDangerTempestEyedMajordomoImperialBarrageCrabEvixion extends Run implements Observer {
    ...
    public void init() throws Exception {
        ...
        this.username = "ForbiddenUltimateDangerTempestEyedMajordomoImperialBarrageCrabEvixion"
                + (Math.random() * 100);
    ...
    public void start(Scanner in) throws InterruptedException {
        ...
        while (this.Running() && this.serverConn.running()) {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                userInput[2] = String.valueOf((int) (Math.random() * 15));
    ...
    public static void main(String[] args) {
        ...
        Run.launch(ForbiddenUltimateDangerTempestEyedMajordomoImperialBarrageCrabEvixion.class, args);
    }
}
